const en = {
  message: {
    ...
    mac_not_support_auto_update: 'Mac Does Not Support Automatic Update, Please Manually Download And Reinstall, Or Run "brew cask reinstall another-redis-desktop-manager"',
